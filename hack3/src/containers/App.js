...
class App extends Component {
  ...
  getStations = async () => {
    const { data: { message , data }  } = await instance.get('/getStations');
    this.setState({
      data: data
    });
  }
  ...
  render() {
    ...
    var two = Object.keys(this.state.data);
    var line1 = this.state.data[two[0]];
    var line2 = this.state.data[two[1]];
